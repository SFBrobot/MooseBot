...
#pragma config(Sensor, I2C_2,  liftEnc,        sensorNone)
#pragma config(Sensor, I2C_3,  rWheelEnc,      sensorNone)
#pragma config(Sensor, I2C_4,  lWheelEnc,      sensorNone)
#pragma config(Motor,  port1,           lift,          tmotorVex393TurboSpeed_HBridge, openLoop)
#pragma config(Motor,  port2,           frWheel,       tmotorVex393HighSpeed_MC29, openLoop, reversed, driveRight)
#pragma config(Motor,  port3,           brWheel,       tmotorVex393HighSpeed_MC29, openLoop, reversed, driveLeft)
#pragma config(Motor,  port4,           mrWheel,       tmotorVex393HighSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port5,           rFly,          tmotorVex393HighSpeed_MC29, openLoop, reversed, driveLeft, encoderPort, I2C_1)
#pragma config(Motor,  port6,           lFly,          tmotorVex393HighSpeed_MC29, openLoop, reversed)
...
#pragma config(Motor,  port9,           tlFly,         tmotorVex393HighSpeed_MC29, openLoop, reversed)
