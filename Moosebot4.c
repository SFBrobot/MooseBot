...
#pragma config(Motor,  port2,           srWheel,       tmotorVex393TurboSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port3,           mrWheel,       tmotorVex393TurboSpeed_MC29, openLoop, reversed, encoderPort, I2C_2)
#pragma config(Motor,  port4,           mlWheel,       tmotorVex393TurboSpeed_MC29, openLoop, encoderPort, I2C_1)
#pragma config(Motor,  port5,           slWheel,       tmotorVex393TurboSpeed_MC29, openLoop)
#pragma config(Motor,  port6,           brFly,         tmotorVex393TurboSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port7,           trFly,         tmotorVex393TurboSpeed_MC29, openLoop)
#pragma config(Motor,  port8,           blFly,         tmotorVex393TurboSpeed_MC29, openLoop)
